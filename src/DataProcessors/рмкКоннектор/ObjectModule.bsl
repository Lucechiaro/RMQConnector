...
Процедура Инициализировать() Экспорт
	...
	// TODO Сделать возможность выбора версии компоненты из константы
    ПодключениеВКУспешно = ПодключитьВнешнююКомпоненту("ОбщийМакет.PinkRabbitMQ3_v2_1_1_149_x32", "BITERP", ТипВнешнейКомпоненты.Native);
