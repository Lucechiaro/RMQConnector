...
Функция ПолучитьДанныеСообщения(ДанныеСообщения, Знач ОбъектДляСериализации, ТочкаПодключения) 
	...
	Если ТочкаПодключения.СпособСериализацииОбъекта = ПредопределенноеЗначение("Перечисление.рмкСпособыСериализации.МетодВстроенногоМенеджера") 
		Или ТочкаПодключения.СпособСериализацииОбъекта = ПредопределенноеЗначение("Перечисление.рмкСпособыСериализации.МетодВстроенногоМенеджера") Тогда
